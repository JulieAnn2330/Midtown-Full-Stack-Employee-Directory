    ...
    return (
        <div className="md:flex justify-between my-6">
            <div className="md:mb-0 mb-4">
                ...
                <button onClick={handleSortByDepartment} className="bg-white focus:bg-yellow-500 focus:text-white focus:outline-none shadow font-bold text-gray-800 rounded px-8 py-1 hover:bg-yellow-500 hover:text-white">Department</button>
            </div>
            <form>
                <input
